...
class ComiRec(BasicModel):
    ...
    def __init__(self, item_num, hidden_size, batch_size, selection=True, T=1, interest_num=4, seq_len=50, add_pos=True, linear_size = 16):
        super(ComiRec, self).__init__(item_num, interest_num, hidden_size, batch_size, seq_len, selection, T, linear_size)
    ...
    def forward(self, item_list, pos_list, mask, train=True):
        ...
        return interest_emb, selection, item_att_w
